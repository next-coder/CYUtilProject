...
@interface CYBannerImageBrowserView ()
...
@implementation CYBannerImageBrowserView
...
+ (instancetype)showImages:(NSArray *)images
    ...
    CYBannerImageBrowserView *bannerImages = [[CYBannerImageBrowserView alloc] initWithFrame:CGRectMake(0, 0, CGRectGetWidth(view.frame), CGRectGetHeight(view.frame))];
    [bannerImages setImages:images placeholder:placeholder firstShowingIndex:index];
    [bannerImages showFromRect:rect inView:view];
    return bannerImages;
}
